...
public class CreateRequest {
    ...
    @Size(min = 5, max = 50, message = "Наименование вакансии должно содержать от 5 до 30 символов")
    ...
    @Size(min = 20, max = 300, message = "Описание вакансии должно содержать от 30 до 300 символов")
    ...
    @Size(min = 20, max = 300, message = "Условия и требования к вакансии должно содержать от 30 до 300 символов")
